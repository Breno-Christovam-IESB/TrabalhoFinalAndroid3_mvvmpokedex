...
data class Sprites( // Declara uma classe de dados
    ...
    val other: com.breno.trabalhofinalandroid3_mvvmpokedex.data.models.remote.responses.Other, // Propriedade other do tipo Other, representando outras imagens do Pokémon
    val versions: com.breno.trabalhofinalandroid3_mvvmpokedex.data.models.remote.responses.Versions // Propriedade versions do tipo Versions, representando versões específicas do Pokémon
)