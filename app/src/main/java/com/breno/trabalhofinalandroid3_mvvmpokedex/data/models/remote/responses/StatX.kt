...
data class StatX( // Declara uma classe de dados
    val name: String, // Propriedade name do tipo String, representando o nome da estatística
    val url: String // Propriedade url do tipo String, representando a URL relacionada à estatística
)