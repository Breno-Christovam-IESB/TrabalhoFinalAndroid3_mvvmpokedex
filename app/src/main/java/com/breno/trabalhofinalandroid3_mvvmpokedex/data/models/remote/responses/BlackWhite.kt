...
data class BlackWhite( // Declara uma classe de dados
    val animated: com.breno.trabalhofinalandroid3_mvvmpokedex.data.models.remote.responses.Animated, // Propriedade animated do tipo Animated, representando uma resposta animada
