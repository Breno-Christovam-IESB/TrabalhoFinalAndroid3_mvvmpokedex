...
data class MoveX( // Declara uma classe de dados
    val name: String, // Propriedade name do tipo String, representando o nome do movimento
    val url: String // Propriedade url do tipo String, representando a URL relacionada ao movimento
)