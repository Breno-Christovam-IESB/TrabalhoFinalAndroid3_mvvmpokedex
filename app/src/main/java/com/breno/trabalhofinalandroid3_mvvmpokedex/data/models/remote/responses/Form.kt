...
data class Form( // Declara uma classe de dados
    val name: String, // Propriedade name do tipo String, representando o nome da forma
    val url: String // Propriedade url do tipo String, representando a URL da forma
)