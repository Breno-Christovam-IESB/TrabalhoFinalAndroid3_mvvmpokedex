...
data class AbilityX( // Declara uma classe de dados
    val name: String, // Propriedade name do tipo String, representando o nome da habilidade
    val url: String // Propriedade url do tipo String, representando a URL da habilidade
)