...
data class RedBlue( // Declara uma classe de dados
    ...
    val backGray: String, // Propriedade backGray do tipo String, representando a URL da imagem das costas em escala de cinza
