...
data class Version( // Declara uma classe de dados
    val name: String, // Propriedade name do tipo String, representando o nome da versão
    val url: String // Propriedade url do tipo String, representando a URL relacionada à versão
)